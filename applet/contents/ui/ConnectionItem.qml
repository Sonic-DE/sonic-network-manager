...
PlasmaExtras.ExpandableListItem {
    ...
    defaultActionButtonAction: Action {
        ...
        Accessible.description: isDeactivated ? i18nc("@info:tooltip %1 connection name", "Connect to %1", connectionItem.title) : i18nc("@info:tooltip %1 connection name", "Disconnect to %1", connectionItem.title)
    }
    ...
    Component {
        ...
        Column {
            ...
            FocusScope {
                ...
                Accessible.description: i18nc("@info:tooltip", "Current download speed is %1 kilobytes per second; current upload speed is %2 kilobytes per seconds", Math.round(rxBytes / 1024), Math.round(txBytes / 1024))
