    ...
    Component {
        ...
        Column {
            ...
            FocusScope {
                ...
                Accessible.description: i18nc("@info:tooltip", "Current download speed is %1 kilobytes per second; current upload speed is %2 kilobytes per second", Math.round(rxBytes / 1024), Math.round(txBytes / 1024))
